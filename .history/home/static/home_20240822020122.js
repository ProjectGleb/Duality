document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleRecordButtonClick() {
        ...
        const url = newRecordingState ? `${window.location.origin}/home/recording_start/` : `${window.location.origin}/home/recording_end/`;
    ...
    function sendTaskDetailsToBackend(taskName, projectName) {
        ...
        fetch(`${window.location.origin}/home/save_task_to_project/`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRFToken': getCSRFToken(),
    ...
    async function handleButton2Click() {
        ...
        window.location.href = 'http:///projects/`;
    }
